...
useSeoMeta({
  title: 'Data-platform — CHOM',
  description:
    'Ingénierie, gouvernance et valorisation de données : pipelines fiables, lineage et catalogue, contrats de données, dataviz et cartographie. Hébergement souverain.',
})
